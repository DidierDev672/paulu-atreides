# Graph Report - book-coffee-shop  (2026-07-29)

## Corpus Check
- 202 files · ~133,785 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2320 nodes · 2665 edges · 220 communities (171 shown, 49 thin omitted)
...
5. `Directive Best Practices` - 11 edges
6. `Per-Route beforeEnter Guards Ignore Param/Query Changes` - 11 edges
7. `Async Navigation Guards Require Proper Promise Handling` - 11 edges
8. `Navigation Guard Infinite Redirect Loops` - 11 edges
9. `Script Setup & Macros` - 11 edges
...
## Communities (220 total, 49 thin omitted)
...
Cohesion: 0.09
Nodes (22): Vue 3, apply essential Vue foundations, vue-best-practices, confirm architecture before coding, consider optional features, core principles, fallthrough attributes, Options API (+14 more)
...
Cohesion: 0.06
Nodes (38): authStore, calcDetailSubtotal(), calcFixedMarkup(), calcSellingPrice(), companyStore, detailsError, emitPage, entryStore (+30 more)

### Community 11 - "CreateSaleModal.vue"
Cohesion: 0.05
Nodes (38): authStore, availableProducts, closeProviderModal(), closeWarehouseModal(), companyStore, discount, emit, filteredAvailableProducts (+30 more)
...
Cohesion: 0.05
Nodes (30): authStore, companyStore, createdOrder, dialogResult, dispatchRecipient, emit, form, formErrors (+22 more)
...
Cohesion: 0.07
Nodes (29): authStore, companyStore, deductEntryQuantities(), detailsSubtotal, discountAmount, emit, fieldErrors, form (+21 more)
...
Cohesion: 0.06
Nodes (24): authStore, editDiscount, editingProviderId, editPaymentMethod, editStatus, filteredSales, limit, page (+16 more)

### Community 26 - "Dune Lore — Paul Atreides y el Ecosistema Paulu"
Cohesion: 0.07
Nodes (25): Cómo usar este documento, Dune Lore — Paul Atreides y el Ecosistema Paulu, El Juramento Paulu, La Casa Paulu, La especia debe fluir — El inventario debe controlarse, Paralelismos técnicos — Backend Paulu (Go API), Paralelismos técnicos — Herramientas y convenciones, Paralelismos técnicos — Módulos de negocio (+17 more)
...
Cohesion: 0.09
Nodes (13): deleting, deletingShipmentId, detailShipment, editShipment, expandedId, filteredShipments, movementLabels, recipientLabels (+5 more)
...
### Community 37 - "WineryRegistrationForm.vue"
Cohesion: 0.05
Nodes (33): CreateWineryRequest, UpdateWineryRequest, WineryResponse, displayWineries, emit, filteredWineries, handleConfirm(), hasError (+25 more)
...
Cohesion: 0.10
Nodes (26): authStore, chatContainer, chatOpen, detectIntentAndFetch(), fetchEntries(), fetchEntryById(), fetchOrderById(), fetchOrders() (+18 more)
...
Cohesion: 0.07
Nodes (14): deleting, deletingOrder, editingOrder, expandedId, filteredOrders, { logDelete, logApprove }, ORDER_TYPE_LABELS, orderStore (+6 more)
...
Cohesion: 0.24
Nodes (5): axios, axios, AxiosHttpClient, HttpError, HttpRequestOptions

### Community 56 - "SaleDetailModal.vue"
Cohesion: 0.14
...
### Community 68 - "vue-router"
Cohesion: 0.18
Nodes (8): vue-router, authStore, AuthView, currentView, router, router, routes, vue-router
...
### Community 71 - "vue-best-practices/SKILL.md"
Cohesion: 0.15
...
### Community 72 - "IAuthRepository.ts"
Cohesion: 0.25
...
Cohesion: 0.15
Nodes (8): expandedId, filteredShipments, search, statuses, statusFilter, store, summaryStats, view
...
### Community 83 - "Best practices for `computed`"
Cohesion: 0.40
...
Cohesion: 0.18
Nodes (11): 10. Referencias, 1. Resumen del proyecto — *La Casa Paulu Areides*, 4.1 Frontend → Backend, 4.2 Consideraciones de diseño, 4. Registro de productos — Flujo completo, 6. Nuevo proyecto generado — Paulu (Vue), 8. Variables de entorno — *Coordenadas del Guild Navigator*, 9. Comandos útiles — *Manual del ornitóptero* (+3 more)

### Community 93 - "providerService.ts"
Cohesion: 0.18
Nodes (4): CreateProviderRequest, ProviderResponse, UpdateProviderRequest, useProviderStore

### Community 94 - "addCategory"
Cohesion: 0.40
...
### Community 139 - "RegisterValidator.ts"
Cohesion: 0.36
...
Cohesion: 0.20
Nodes (6): CreateTaxInformationRequest, TaxInformationResponse, authRepository, container, httpClient, axiosInstance
...
### Community 152 - "Guía de instalación — *Primer vuelo en ornitóptero*"
Cohesion: 0.33
...
### Community 153 - "Paulus — Guía de usuario"
Cohesion: 0.33
...
### Community 159 - "historyService.ts"
Cohesion: 0.39
...
### Community 177 - "7. Convenciones del código — *Código de honor Atreides*"
Cohesion: 0.67
Nodes (3): 7.1 Frontend — *Lenguaje de Usul*, 7.2 Backend — *Lenguaje del Imperio*, 7. Convenciones del código — *Código de honor Atreides*
...
### Community 216 - "HistoryEntry.ts"
Cohesion: 0.50
Nodes (3): HistoryAction, HistoryChange, HistoryEntry

## Knowledge Gaps
- **1183 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+1178 more)
...
- **Why does `axios` connect `AxiosHttpClient.ts` to `Paulus (Vue 3 Frontend)`, `companyService.ts`, `axiosInstance.ts`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `vue-router`, `Paulus (Vue 3 Frontend)`, `invoiceService.js`, `package.json`, `AxiosHttpClient.ts`?**
