# Graph Report - book-coffee-shop  (2026-07-31)

## Corpus Check
- 210 files · ~135,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2356 nodes · 2694 edges · 224 communities (176 shown, 48 thin omitted)
...
## Communities (224 total, 48 thin omitted)
...
Cohesion: 0.13
Nodes (17): App.vue (Root Component), createGlobalState (VueUse), JWT Authentication (HS256), localStorage (Browser), main.ts (Entry Point), vue-markdown-render, @vueuse/motion, tailwindcss (+9 more)
...
Cohesion: 0.06
Nodes (20): vue-router, deleting, deletingOrder, editingOrder, expandedId, filteredOrders, { logDelete, logApprove }, ORDER_TYPE_LABELS (+12 more)
...
Cohesion: 0.17
Nodes (9): LoginDto, LoginUseCase, AuthSession, User, IAuthRepository, LoginCredentials, RegisterData, AuthApiResponse (+1 more)

### Community 56 - "historyService.ts"
Cohesion: 0.17
...
Cohesion: 0.12
Nodes (17): devDependencies, @tailwindcss/vite, @types/node, @types/pdfmake, vite, vite-tsconfig-paths, @vitejs/plugin-vue, vue-tsc (+9 more)
...
## Knowledge Gaps
- **1199 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+1194 more)
...
- **Why does `vue-router` connect `OrderList.vue` to `Paulus (Vue 3 Frontend)`, `OrderForm.vue`, `vue-best-practices`?**
