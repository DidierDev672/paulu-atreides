...
- askStockAssistant.ts
- AxiosCompanyLookup.ts
- checkWineries
- handleSubmit
...
8. `2. Frontend — Paulus (Vue 3) — *Rostro de Paul ante los fremen*` - 12 edges
9. `Paulus — El Primer Miembro de Paulu Areides` - 12 edges
10. `IStockAssistantContextGateway` - 11 edges

## Surprising Connections (you probably didn't know these)
- `extractSpreadsheet()` --references--> `xlsx`  [EXTRACTED]
  src/application/services/documentTextExtractor.ts → package.json
- `useStockAssistantChat()` --indirect_call--> `scrollToBottom()`  [INFERRED]
  src/features/stock-movements/assistant/presentation/composables/useStockAssistantChat.ts → src/App.vue
...
Cohesion: 0.09
Nodes (26): AuthAlertMessage, matches(), resolveLoginAlertMessage(), resolveRegisterAlertMessage(), alertMessage, authStore, clearFieldErrors(), emit (+18 more)

### Community 16 - "OrderForm.vue"
Cohesion: 0.05
Nodes (33): authStore, companyName, companyStore, createdOrder, dialogResult, dispatchRecipient, emit, form (+25 more)
...
Cohesion: 0.09
Nodes (32): authStore, chatContainer, chatOpen, detectIntentAndFetch(), fetchEntries(), fetchEntryById(), fetchOrderById(), fetchOrders() (+24 more)
...
Cohesion: 0.08
Nodes (12): deleting, deletingOrder, editingOrder, expandedId, filteredOrders, { logDelete, logApprove }, ORDER_TYPE_LABELS, orderStore (+4 more)
...
Cohesion: 0.32
Nodes (7): getProviderById(), IProviderLookup, StockProviderReference, asString(), AxiosProviderLookup, providerLookup, toStockProviderReference()
...
### Community 72 - "presets.ts"
Cohesion: 0.25
Nodes (6): DEFAULT_STAGGER, MODAL_BACKDROP_TRANSITION, MODAL_ZOOM_FADE, ModalMotionPreset, MotionVariant, StaggerMotionOptions
...
Cohesion: 0.10
Nodes (20): getProductById(), getProductCatalog(), IProductCatalog, StockProduct, asCategories(), asNumber(), asString(), AxiosProductCatalog (+12 more)
...
Cohesion: 0.15
Nodes (15): createStockMovement(), createStockMovementForProduct(), deleteStockMovement(), getStockMovementById(), getStockMovements(), mapOrderTypeToMovementType(), ORDER_TYPE_TO_MOVEMENT, registerStockMovementsForOrder() (+7 more)
...
### Community 163 - "historyService.ts"
Cohesion: 0.17
...
### Community 177 - "stockMovementStore.ts"
Cohesion: 0.24
Nodes (11): formatOrderReferenceLabel(), getOrderReferenceById(), indexProductsById(), resolveOrderReferences(), IOrderReferenceLookup, StockOrderReference, asString(), AxiosOrderReferenceLookup (+3 more)
...
### Community 190 - "askStockAssistant.ts"
Cohesion: 0.05
Nodes (36): askStockAssistant(), AskStockAssistantResult, buildStockAssistantContext(), count(), pickFocusedPayload(), resolveDetailById(), summarizeList(), detectStockAssistantIntent() (+28 more)

### Community 191 - "AxiosCompanyLookup.ts"
Cohesion: 0.32
Nodes (7): getCompanyById(), ICompanyLookup, StockCompanyReference, asString(), AxiosCompanyLookup, companyLookup, toStockCompanyReference()

### Community 194 - "updateFinancialSummary"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (11): emit, { panelMotion, backdropTransition }, model, assistantOpen, detailOpen, filteredMovements, orderLabelsById, pendingDelete (+3 more)
...
### Community 215 - "AxiosWineryLookup.ts"
Cohesion: 0.32
...
### Community 235 - "stock-movements/index.ts"
Cohesion: 0.40
Nodes (6): filterMovementsByProductQuery(), matchProductSearchQuery(), OrderLineForStockResolve, ProductCodeLookup, resolveProductIdsFromCodes(), StockMovementProductInput

### Community 237 - "Paulus — Guía de usuario"
Cohesion: 0.33
