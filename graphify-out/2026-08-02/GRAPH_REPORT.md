...
10. `Directive Best Practices` - 11 edges
...
Cohesion: 0.23
Nodes (12): getProviderById(), OrderLineForStockResolve, ProductCodeLookup, resolveProductIdsFromCodes(), IProviderLookup, StockMovementProductInput, StockProviderReference, asString() (+4 more)
...
Cohesion: 0.30
Nodes (9): formatOrderReferenceLabel(), getOrderReferenceById(), resolveOrderReferences(), IOrderReferenceLookup, StockOrderReference, asString(), AxiosOrderReferenceLookup, orderReferenceLookup (+1 more)
