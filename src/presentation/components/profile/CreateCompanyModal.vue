...
import { createCompany, type CompanyResponse } from '@/application/services/companyService'
    ...
    >
      ...
      >
        <div class="mb-2 flex items-start justify-between">
          <div>
            <h2 class="text-xl font-bold text-white">Agregar empresa</h2>
            <p class="mt-1 text-sm text-slate-400">
              Vincula una empresa a tu cuenta para gestionar tus operaciones.
            </p>
          </div>
          <button
            type="button"
            ...
            <div class="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Ganadería Estelar"
                />
              </div>
              <div>
                <label class="mb-1.5 block text-sm font-semibold text-white">
